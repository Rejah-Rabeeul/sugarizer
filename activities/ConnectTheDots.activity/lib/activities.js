...
define(["sugar-web/datastore", "util"], function (datastore, util) {
	...
	var updateList = function (newlist) {
		console.log("Sugarizer loaded " + newlist.length + " activities from JSON.");
		var colorLab = newlist.find(a => a.id === "org.sugarlabs.ColorLab") || newlist.find(a => a.name === "ColorLab");
		console.log("Is ColorLab in JSON?", colorLab ? "YES" : "NO", colorLab);
